...
import { getJobTitlesForSector } from "../../lib/jobTitles";
...
export default function StepThree({ selected, onChange, industry }: StepThreeProps) {
  const roles = getJobTitlesForSector(industry);
