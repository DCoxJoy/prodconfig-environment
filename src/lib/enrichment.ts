...
// Generated: 2026-06-26T22:32:04.207Z via POST /api/admin/enrich
...
export const PRODUCT_ENRICHMENT: Record<string, ProductEnrichment> = {
  ...
  'MMU332':    { mount_surface: 'vehicle' },
  'MMU331':    { mount_surface: 'wall' },
  'MVU332':    { mount_surface: 'wall' },
  'MMU231':    { mount_surface: 'wall' },
  'MMU230':    { mount_surface: 'pole' },
  'MMU232':    { mount_surface: 'vehicle' },
  'MVU232':    { mount_surface: 'wall' },
