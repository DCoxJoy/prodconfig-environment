...
export const ALL_FEATURES: Feature[] = [
  ...
  { id: 'vesa_compatible',    title: 'Secure mount compatible',       desc: 'VESA mount — attaches to standard wall, arm, or kiosk mounts' },
  { id: 'magconnect',         title: 'Magnetic mount compatible',     desc: 'MagConnect mount — quick-attach magnetic mounting system' },
